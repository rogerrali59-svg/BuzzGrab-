...
class LiveOrderScreen extends GetView<LiveOrderController> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    final status = controller.orderDetailsModel.value.data?.status;
                    final step = controller.currentStep.value;

                    // Show ONLY when we are at step 3 (same step as Complete Delivery)
                    final showButton =
                    ...
                    return showButton
                        ? buttonFailedWidget(
                      buttonText: keyProblemWithDelivery.tr,
                      onTap: () {
                        print("Problem with delivery clicked at step: $step");
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ...List.generate(reasons.length, (index) {
                                    bool selected = selectedReason.value == (index + 1);

                                    return GestureDetector(
                                      onTap: () {
                                        selectedReason.value = index + 1;
                                      },
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            color: selected ? colorAppColor : Colors.grey.shade300,
                                            width: 1.5,
                                          ),
                                          color: selected
                                              ? colorAppColor.withOpacity(0.1)
                                              : Colors.white,
                                        ),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Text(
                                              ...
                                              style: TextStyle(
                                                ...
                                                color:
                                                selected ? colorAppColor : Colors.black87,
                                              ),
                                            ),
                                            Icon(
                                              selected
                                              ...
                                              color: selected ? colorAppColor : Colors.grey,
                                            ),
                                          ],
                                        ),
                                      ),
                                  ...
                                  buttonWidget(
                                    ...
                                    onTap: () {
                                      ...
                                      String finalReason = selectedReason.value == 3
                                          ? otherController.text.trim()
                                          : reasons[selectedReason.value - 1];

                                      print("Final Reason: $finalReason");
                        ...
                        : SizedBox.shrink();
                  }).marginSymmetric(vertical: height_10),
                  ...
                  children: List.generate(steps.length, (index) {
                    ...
                    return Column(
                      children: [
                        Container(
                          decoration: BoxDecoration(
                            color: isCompleted ? colorAppColor : Colors.white,


                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                              color:
                                  isCompleted ?colorAppColor: Colors.white,
  ...
  buttonFailedWidget({onTap, buttonText}) {
    return ElevatedButton.icon(
      onPressed: onTap,
      label: Text(
        buttonText,
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: colorLightRedColor,
        minimumSize: Size(double.infinity, 50),

        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8),),
        side: BorderSide(color:colorLightRedColor )
