...
import 'package:alcoholdeliverydriver/app/core/widgets/custom_appbar.dart';
...
class EarningScreen extends GetView<EarningController> {
    ...
    return PopScope(
      ...
      child: AnnotatedRegionWidget(
        ...
        child: Scaffold(
          ...
          appBar: CustomAppBar(
            appBarTitleText: keyMyEarnings.tr,titleColor: Colors.white,
            centerTitle: false,
            bgColor: colorAppColor,
            isBackIcon: false,
  ...
  coloumWidget({title, value}) {
    return Container(
      ...
      ).paddingSymmetric(horizontal: width_10, vertical: height_20),
    );
  }
}
