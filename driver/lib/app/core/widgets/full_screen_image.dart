      ...
      body: Stack(
        ...
        children: [
          Center(
            child: Hero(
              tag: heroTag,
              child: InteractiveViewer(  // optional: pinch to zoom
                child: Image.network(
                  imageUrl,
                  fit: BoxFit.contain,
                ),
...
class FullScreenPage extends StatefulWidget {
  FullScreenPage({required this.child, this.backgroundColor = Colors.black, this.backgroundIsTransparent = true, this.disposeLevel = DisposeLevel.Medium});
