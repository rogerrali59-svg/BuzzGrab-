...
import 'package:buzzgrab/app/modules/authentication/controllers/account_inreview_controller.dart';
        ...
        (value) {
          if (value != null) {
            ...
            if (signUpData.value.isVerified == false) {
              ...
              if (signUpData.value.isAddress == false) {
                Get.toNamed(AppRoutes.locationPickerScreen, arguments: {
                  'fromLogin': true,
                });
              } else {
