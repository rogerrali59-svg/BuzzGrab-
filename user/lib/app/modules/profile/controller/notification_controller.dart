...
import 'package:buzzgrab/app/modules/profile/model/notification_response_model.dart';
...
class NotificationController extends GetxController {
  ...
  getNotifications() async {
    await DioClient()
        .get('/api/driver-notification-listing-api/', skipAuth: false)
        .then((v) {
      notifications.clear();
  ...
  Future<void> clearAllNotifications() async {
    try {
      final response = await DioClient().delete(
        '/api/clear-all-notifications-api/',
        skipAuth: false,
      );
