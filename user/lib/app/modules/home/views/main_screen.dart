...
import 'package:buzzgrab/app/modules/earning/views/earning_screen.dart';
import 'package:buzzgrab/app/modules/favourite/views/wishlist_product_screen.dart';
                ...
                child: Container(
                  ...
                  child: BottomNavigationBar(
                    ...
                    items: [
                      ...
                      BottomNavigationBarItem(
                        icon: AssetImageWidget(
                          imageUrl: iconInActiveFavourite,
                          imageHeight: height_20,
                        ).paddingOnly(top: height_6, bottom: height_6),
                        activeIcon: AssetImageWidget(
                          imageUrl: iconActiveFavourite,
                          imageHeight: height_20,
                          color: colorAppColor,
                        ).paddingOnly(top: height_6, bottom: height_6),
                        label: 'Favourites',
                      ...
                      BottomNavigationBarItem(
                        icon: AssetImageWidget(
                          imageUrl: iconInActiveHistory,
                          imageHeight: height_20,
                        ).paddingOnly(top: height_6, bottom: height_6),
                        activeIcon: AssetImageWidget(
                          imageUrl: iconActiveHistory,
                          imageHeight: height_20,
                          color: colorAppColor,
                        ).paddingOnly(top: height_6, bottom: height_6),
                        label: 'History',
