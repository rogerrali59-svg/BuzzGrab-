...
class IntlPhoneFieldd extends StatefulWidget {
  ...
  IntlPhoneFieldd({
    ...
    this.dropdownIcon = const Icon(Icons.keyboard_arrow_down),
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: widget.decoration.copyWith(
        errorStyle: Theme.of(Get.context!).textTheme.bodySmall!.copyWith(fontSize: font_10, fontWeight: FontWeight.w500, color: Colors.red),
        filled: true,
        contentPadding: EdgeInsets.symmetric(vertical: margin_15, horizontal: margin_15),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.showCountryFlag) ...[
                  ...
                  if ( widget.showDropdownIcon && widget.dropdownIconPosition == IconPosition.leading) ...[
                    widget.dropdownIcon,
                ...
                FittedBox(
                  child: Text(
                    ...
                    style: textStyleBodyMedium().copyWith(fontSize: font_12),
