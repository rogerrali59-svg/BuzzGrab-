...
import 'package:alcoholdeliverydriver/app/modules/logger/log_interceptor.dart'
    as LogInterceptor;
import '../../../../export.dart';
...
//ashish local
// String baseUrl = "http://192.168.1.157:2316/api";
...
/*Future getUserAgent() async {
  ...
  if (Platform.isAndroid) {
    ...
    details.deviceType = "2";
  }
  PackageInfo packageInfo = await PackageInfo.fromPlatform();
  return "alcoholdeliverydriver/${packageInfo.version}/${kDebugMode == true ? "Dev" : "Release"}/(${details.deviceName}/Android : ${details.deviceVersion})";
}*/
Future getUserAgent() async {
  DeviceDetails details = DeviceDetails();
  DeviceInfoPlugin info = DeviceInfoPlugin();
