import 'package:alcoholdeliverydriver/app/modules/setting/controller/change_password_controller.dart';
...
class ChangePasswordScreen extends GetView<ChangePasswordController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        appBarTitleText: 'Change pasword',
      ),
      body: _bodyWidget(),
    );
  }
            ...
            Obx(
              () => TextFieldWidget(
                  ...
                  validate: (value) => FieldChecker.fieldChecker(
                      value: value, message: 'Old Password'),
